...
public class MissingInformationTable {
	...
	private boolean isNonexistentEmployee = false;
	...
	public void setIsNonexistentEmployee(boolean isNonexistentEmployee){
		this.isNonexistentEmployee = isNonexistentEmployee;
		if (isNonexistentEmployee) isSomethingAmiss = true;
	}
